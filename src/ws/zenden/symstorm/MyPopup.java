...
public class MyPopup extends MyPopupBase{
  private static final Key<MyPopup> CHOOSE_BY_NAME_POPUP_IN_PROJECT_KEY = new Key<MyPopup>("ws.zenden.MyPopup");
 ...
 /*
  @Nullable
  public static ws.zenden.MyPopup getActivePopup(@NotNull final Project project) {
 ...
 /* public static ws.zenden.MyPopup createPopup(final Project project, final ws.zenden.MyModel model/*, final PsiElement context) {
